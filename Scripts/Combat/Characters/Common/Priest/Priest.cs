...
public class Priest : PlayerCombatAI
{
    ...
    public override void OnCombatStart()
    {
        ...
        if (currentSkill is Blessing && !useFirstTime)
        {
            GainMana(100);
            useFirstTime = true;
        }
    ...
    protected override void InitializeStates()
    {
        ...
        var skillState = new PriestSkillState(this);
        ...
        stateMachine.AddTransition(moveState, attackState, new FuncPredicate(() => IsTargetInAttackRange() 
        && CheckTarget()));
