...
public class DarkKnight : PlayerCombatAI
{
    ...
    private float damageTakenLastInterval = 0;
    ...
    protected override void InitializeStates()
    {
        ...
        var skillState = new DarkKnight_SkillState(this);
    ...
    public override void AddShield(float amount)
    {
        if (isShieldOn) 
        {
            return;          
