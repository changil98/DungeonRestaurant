...
public class RuneBlade : PlayerCombatAI
{
    ...
    protected override void InitializeStates()
    {
        ...
        var skillState = new RunBlade_SkillState(this);
    ...
    public override void TakeDamage(float damage, DamageType damageType,AttackType attackType, bool isCritical = false)
    {
        if (damageType == DamageType.Magical && currentSkill is MagicEater magicEater)
        {
            magicEater.OnMagicDamageReceived(this);
        }
        base.TakeDamage(damage, DamageType.Magical,attackType);
